...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1309getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return ((int) (this.step ^ (this.step >>> 32))) + (((((int) ULong.m269constructorimpl(this.first ^ ULong.m269constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m269constructorimpl(this.last ^ ULong.m269constructorimpl(this.last >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m315toStringimpl(this.first)).append("..").append((Object) ULong.m315toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m315toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m315toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
