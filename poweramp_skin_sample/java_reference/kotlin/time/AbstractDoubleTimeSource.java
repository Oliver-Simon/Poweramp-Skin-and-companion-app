...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1433plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1469plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1432minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1445equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1465isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1531getZEROUwyO8pc();
            }
            ...
            return Duration.m1445equalsimpl0(startedAtDiff, Duration.m1484unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1531getZEROUwyO8pc() : Duration.m1469plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1445equalsimpl0(mo1432minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1531getZEROUwyO8pc());
        }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1480toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1531getZEROUwyO8pc(), null);
    }
}
