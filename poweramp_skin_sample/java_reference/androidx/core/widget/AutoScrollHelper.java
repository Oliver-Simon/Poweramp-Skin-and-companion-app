...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long currentTime) {
            ...
            return (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - this.mStopValue) + (this.mStopValue * AutoScrollHelper.constrain(((float) elapsedSinceEnd2) / this.mEffectiveRampDown, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY));
        }
