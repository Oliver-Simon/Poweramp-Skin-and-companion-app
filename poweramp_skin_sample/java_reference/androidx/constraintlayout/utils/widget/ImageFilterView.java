...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        private void warmth(float warmth) {
            ...
            float centiKelvin2 = 5000.0f / f;
            if (centiKelvin2 <= 66.0f) {
                f6 = 10.0f;
                colorG2 = (((float) Math.log(centiKelvin2)) * f4) - 161.11957f;
                colorR2 = 255.0f;
            } else {
                f6 = 10.0f;
                float tmp2 = centiKelvin2 - f3;
            ...
            if (centiKelvin2 >= 66.0f) {
                ...
                colorB2 = (((float) Math.log(centiKelvin2 - f6)) * 138.51773f) - f5;
            } else {
                colorB2 = 0.0f;
            }
