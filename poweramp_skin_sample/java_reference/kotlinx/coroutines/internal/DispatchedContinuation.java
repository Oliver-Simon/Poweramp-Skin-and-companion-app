...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(11:13|14|15|(3:69|70|(8:72|73|18|(12:20|21|22|(2:54|55)(1:24)|25|26|27|28|29|30|(1:42)|34)(1:67)|35|(1:36)|39|40))|17|18|(0)(0)|35|(1:36)|39|40) */
    ...
    */
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m95constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
