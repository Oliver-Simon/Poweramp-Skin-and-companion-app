...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    public final void registerSelectForOnJoin(SelectInstance<?> select, Object ignoredParam) {
        if (!joinInternal()) {
            ...
            DisposableHandle disposableHandle = JobKt.invokeOnCompletion$default(this, false, false, new SelectOnJoinCompletionHandler(select), 3, null);
    ...
    */
    ...
    public final void onAwaitInternalRegFunc(SelectInstance<?> select, Object ignoredParam) {
        ...
        DisposableHandle disposableHandle = JobKt.invokeOnCompletion$default(this, false, false, new SelectOnAwaitCompletionHandler(select), 3, null);
        select.disposeOnCompletion(disposableHandle);
    }
