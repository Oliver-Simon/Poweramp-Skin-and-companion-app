    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ReceiveChannel values3 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(flowKt__DelayKt$sample$2.$this_sample, null), 1, null);
        ...
        while (lastValue.element != NullSurrogateKt.DONE) {
            ...
            $this$invokeSuspend_u24lambda_u240.invoke(values.getOnReceiveCatching(), new FlowKt__DelayKt$sample$2$1$1(lastValue, values2, null));
            $this$invokeSuspend_u24lambda_u240.invoke(values2.getOnReceive(), new FlowKt__DelayKt$sample$2$1$2(lastValue, downstream, null));
