...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1583delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m1584toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1584toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean m1467isPositiveimpl = Duration.m1467isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (m1467isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1451getInWholeMillisecondsimpl(Duration.m1469plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m1467isPositiveimpl) {
