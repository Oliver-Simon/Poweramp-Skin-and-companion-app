...
public interface ReceiveChannel<E> {
    ...
    Object mo1599receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1600tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1600tryReceivePtdJZtk = receiveChannel.mo1600tryReceivePtdJZtk();
            if (ChannelResult.m1616isSuccessimpl(mo1600tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1612getOrThrowimpl(mo1600tryReceivePtdJZtk);
            }
            Throwable m1610exceptionOrNullimpl = ChannelResult.m1610exceptionOrNullimpl(mo1600tryReceivePtdJZtk);
            if (m1610exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1610exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L37:
                ...
                r2 = 1
                r0.label = r2
                java.lang.Object r3 = r3.mo1599receiveCatchingJP2dKIU(r0)
                if (r3 != r1) goto L44
                return r1
            L44:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1611getOrNullimpl(r3)
                return r3
            */
