...
public interface SendChannel<E> {
    ...
    Object mo1595trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1595trySendJP2dKIU(e);
            if (ChannelResult.m1616isSuccessimpl(result)) {
                return true;
            }
            Throwable m1610exceptionOrNullimpl = ChannelResult.m1610exceptionOrNullimpl(result);
