...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo1652scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1652scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    public void mo1651dispatch(CoroutineContext context, Runnable block) {
        ...
        if (runningWorkers$volatile$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo1651dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo1651dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
