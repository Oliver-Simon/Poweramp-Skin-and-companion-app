...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m95constructorimpl = Result.m95constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m95constructorimpl = Result.m95constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m101isFailureimpl(m95constructorimpl) ? null : m95constructorimpl);
