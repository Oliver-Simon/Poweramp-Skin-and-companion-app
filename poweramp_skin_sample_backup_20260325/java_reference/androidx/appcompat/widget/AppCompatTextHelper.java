...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList textColor3 = null;
        ...
        if (ap != -1) {
            ...
            if (Build.VERSION.SDK_INT < 23) {
                if (a2.hasValue(R.styleable.TextAppearance_android_textColor)) {
                    textColor3 = a2.getColorStateList(R.styleable.TextAppearance_android_textColor);
                }
                if (a2.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
                    textColorHint2 = a2.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
                }
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            textColor2 = textColorLink;
        } else {
            if (a3.hasValue(R.styleable.TextAppearance_android_textColor)) {
                textColor3 = a3.getColorStateList(R.styleable.TextAppearance_android_textColor);
            }
            if (a3.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
                textColorHint2 = a3.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
            }
            if (!a3.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
                ...
                textColor = textColor3;
                textColorHint = textColorHint2;
                textColor2 = a3.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
            }
        }
        ...
        boolean allCapsSet3 = allCapsSet;
        ...
        if (textColor2 != null) {
            this.mView.setLinkTextColor(textColor2);
        }
        if (!hasPwdTm && allCapsSet3) {
            setAllCaps(allCaps);
        }
        ...
        if (a.hasValue(R.styleable.TextAppearance_android_fontFamily) || a.hasValue(R.styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                ...
                ResourcesCompat.FontCallback replyCallback = new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                    ...
                    public void m42xb24343b7(int reason) {
                    }
                };
                try {
