...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UInt) {
            return m607containsWZ4Q5Ns(((UInt) element).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int index) {
        return UInt.m184boximpl(m608getpVg5ArA(index));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object element) {
        if (element instanceof UInt) {
            return m609indexOfWZ4Q5Ns(((UInt) element).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object element) {
        if (element instanceof UInt) {
            return m610lastIndexOfWZ4Q5Ns(((UInt) element).getData());
        }
        return -1;
    }
    ...
    public int get_size() {
        return UIntArray.m251getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m253isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m607containsWZ4Q5Ns(int element) {
        return UIntArray.m246containsWZ4Q5Ns(this.$this_asList, element);
    }

    /* renamed from: get-pVg5ArA, reason: not valid java name */
    public int m608getpVg5ArA(int index) {
        return UIntArray.m250getpVg5ArA(this.$this_asList, index);
    }

    /* renamed from: indexOf-WZ4Q5Ns, reason: not valid java name */
    public int m609indexOfWZ4Q5Ns(int element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns, reason: not valid java name */
    public int m610lastIndexOfWZ4Q5Ns(int element) {
