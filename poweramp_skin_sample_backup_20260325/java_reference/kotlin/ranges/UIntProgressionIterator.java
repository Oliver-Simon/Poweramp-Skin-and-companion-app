...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m184boximpl(m1329nextpVg5ArA());
    }
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r0 = kotlin.UInt.m190constructorimpl(r6)
            r3.step = r0
    ...
    public int m1329nextpVg5ArA() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = UInt.m190constructorimpl(this.next + this.step);
        }
        return value;
    }
}
