...
public interface TimeMark {
    ...
    TimeMark mo1431minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1433plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1554plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1553minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1433plusLRDsOJo(Duration.m1484unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1466isNegativeimpl($this.mo1430elapsedNowUwyO8pc());
        }
