...
public final class DurationKt {
    ...
    private static final long m1537timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1471timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1536timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1440constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1440constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1440constructorimpl((normalValue << 1) + unitDiscriminator);
    }
