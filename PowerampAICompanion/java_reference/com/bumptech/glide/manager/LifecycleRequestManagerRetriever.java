...
public final class LifecycleRequestManagerRetriever {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public LifecycleRequestManagerRetriever(RequestManagerRetriever.RequestManagerFactory factory) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RequestManager getOrCreate(Context context, Glide glide, final androidx.lifecycle.Lifecycle lifecycle, FragmentManager childFragmentManager, boolean isParentVisible) {
        Util.assertMainThread();
