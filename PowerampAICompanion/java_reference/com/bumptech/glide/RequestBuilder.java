...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public RequestBuilder<TranscodeType> transition(TransitionOptions<?, ? super TranscodeType> transitionOptions) {
        if (isAutoCloneEnabled()) {
            return mo80clone().transition(transitionOptions);
        }
    ...
    public RequestBuilder<TranscodeType> listener(RequestListener<TranscodeType> requestListener) {
        if (isAutoCloneEnabled()) {
            return mo80clone().listener(requestListener);
        }
    ...
    public RequestBuilder<TranscodeType> addListener(RequestListener<TranscodeType> requestListener) {
        if (isAutoCloneEnabled()) {
            return mo80clone().addListener(requestListener);
        }
    ...
    public RequestBuilder<TranscodeType> error(RequestBuilder<TranscodeType> errorBuilder) {
        if (isAutoCloneEnabled()) {
            return mo80clone().error((RequestBuilder) errorBuilder);
        }
    ...
    private RequestBuilder<TranscodeType> cloneWithNullErrorAndThumbnail() {
        return mo80clone().error((RequestBuilder) null).thumbnail((RequestBuilder) null);
    }

    public RequestBuilder<TranscodeType> thumbnail(RequestBuilder<TranscodeType> thumbnailRequest) {
        if (isAutoCloneEnabled()) {
            return mo80clone().thumbnail(thumbnailRequest);
        }
    ...
    public RequestBuilder<TranscodeType> thumbnail(float sizeMultiplier) {
        if (isAutoCloneEnabled()) {
            return mo80clone().thumbnail(sizeMultiplier);
        }
    ...
    private RequestBuilder<TranscodeType> loadGeneric(Object model) {
        if (isAutoCloneEnabled()) {
            return mo80clone().loadGeneric(model);
        }
        this.model = model;
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    /* renamed from: clone */
    public RequestBuilder<TranscodeType> mo80clone() {
        RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.mo80clone();
        requestBuilder.transitionOptions = (TransitionOptions<?, ? super TranscodeType>) requestBuilder.transitionOptions.m81clone();
        ...
        if (requestBuilder.thumbnailBuilder != null) {
            requestBuilder.thumbnailBuilder = requestBuilder.thumbnailBuilder.mo80clone();
        }
        if (requestBuilder.errorBuilder != null) {
            requestBuilder.errorBuilder = requestBuilder.errorBuilder.mo80clone();
        }
        return requestBuilder;
    }
    ...
    public ViewTarget<ImageView, TranscodeType> into(ImageView view) {
        ...
        if (!requestOptions.isTransformationSet() && requestOptions.isTransformationAllowed() && view.getScaleType() != null) {
            switch (AnonymousClass1.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
                case 1:
                    requestOptions = requestOptions.mo80clone().optionalCenterCrop();
                    break;
                case 2:
                    requestOptions = requestOptions.mo80clone().optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    requestOptions = requestOptions.mo80clone().optionalFitCenter();
                    break;
                case 6:
                    requestOptions = requestOptions.mo80clone().optionalCenterInside();
                    break;
    ...
    private Request buildRequestRecursive(Object requestLock, Target<TranscodeType> target, RequestListener<TranscodeType> targetListener, RequestCoordinator parentCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int overrideWidth, int overrideHeight, BaseRequestOptions<?> requestOptions, Executor callbackExecutor) {
        ...
        Request mainRequest = buildThumbnailRequestRecursive(obj, target, targetListener, parentCoordinator2, transitionOptions, priority, overrideWidth, overrideHeight, requestOptions, callbackExecutor);
    ...
    private Request buildThumbnailRequestRecursive(Object requestLock, Target<TranscodeType> target, RequestListener<TranscodeType> targetListener, RequestCoordinator parentCoordinator, TransitionOptions<?, ? super TranscodeType> transitionOptions, Priority priority, int overrideWidth, int overrideHeight, BaseRequestOptions<?> requestOptions, Executor callbackExecutor) {
        ...
        if (this.thumbnailBuilder != null) {
            ...
            TransitionOptions<?, ? super TranscodeType> thumbTransitionOptions3 = thumbTransitionOptions;
            ...
            Request thumbRequest = this.thumbnailBuilder.buildRequestRecursive(requestLock, target, targetListener, coordinator, thumbTransitionOptions3, thumbPriority, thumbOverrideWidth, thumbOverrideHeight, this.thumbnailBuilder, callbackExecutor);
        ...
        if (this.thumbSizeMultiplier != null) {
            ...
            BaseRequestOptions<?> thumbnailOptions = requestOptions.mo80clone().sizeMultiplier(this.thumbSizeMultiplier.floatValue());
