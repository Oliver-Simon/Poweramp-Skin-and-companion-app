...
public class Registry {
    ...
    public <Data, TResource, Transcode> LoadPath<Data, TResource, Transcode> getLoadPath(Class<Data> dataClass, Class<TResource> resourceClass, Class<Transcode> transcodeClass) {
        Class<Data> dataClass2;
        Class<TResource> resourceClass2;
        Class<Transcode> transcodeClass2;
        ...
        if (result == null) {
            ...
            if (decodePaths.isEmpty()) {
                ...
                resourceClass2 = resourceClass;
                transcodeClass2 = transcodeClass;
            } else {
                dataClass2 = dataClass;
                resourceClass2 = resourceClass;
                transcodeClass2 = transcodeClass;
                result = new LoadPath<>(dataClass2, resourceClass2, transcodeClass2, decodePaths, this.throwableListPool);
            }
            this.loadPathCache.put(dataClass2, resourceClass2, transcodeClass2, result);
        }
        return result;
    }
