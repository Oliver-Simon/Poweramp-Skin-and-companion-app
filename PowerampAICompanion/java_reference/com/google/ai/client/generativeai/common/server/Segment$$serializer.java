...
public final class Segment$$serializer implements GeneratedSerializer<Segment> {
    ...
    static {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.server.Segment", INSTANCE, 2);
