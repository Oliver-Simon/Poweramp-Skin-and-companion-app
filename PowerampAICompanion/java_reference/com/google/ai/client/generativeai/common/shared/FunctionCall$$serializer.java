...
public final class FunctionCall$$serializer implements GeneratedSerializer<FunctionCall> {
    public static final FunctionCall$$serializer INSTANCE = new FunctionCall$$serializer();
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.shared.FunctionCall", INSTANCE, 2);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        kSerializerArr = FunctionCall.$childSerializers;
    ...
    public void serialize(Encoder encoder, FunctionCall value) {
        ...
        FunctionCall.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
