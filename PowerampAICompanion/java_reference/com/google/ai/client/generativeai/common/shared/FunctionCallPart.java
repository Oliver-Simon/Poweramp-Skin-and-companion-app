...
public final /* data */ class FunctionCallPart implements Part {
    ...
    public /* synthetic */ FunctionCallPart(int seen1, FunctionCall functionCall, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (seen1 & 1)) {
            PluginExceptionsKt.throwMissingFieldException(seen1, 1, FunctionCallPart$$serializer.INSTANCE.getDescriptor());
        }
