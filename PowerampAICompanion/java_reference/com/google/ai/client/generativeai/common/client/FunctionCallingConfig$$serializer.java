...
public final class FunctionCallingConfig$$serializer implements GeneratedSerializer<FunctionCallingConfig> {
    public static final FunctionCallingConfig$$serializer INSTANCE = new FunctionCallingConfig$$serializer();
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.client.FunctionCallingConfig", INSTANCE, 1);
    ...
    public void serialize(Encoder encoder, FunctionCallingConfig value) {
        ...
        beginStructure.encodeSerializableElement(descriptor2, 0, FunctionCallingConfig.$childSerializers[0], value.mode);
        beginStructure.endStructure(descriptor2);
    }
