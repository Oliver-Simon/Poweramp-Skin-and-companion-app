...
public final class FunctionResponse$$serializer implements GeneratedSerializer<FunctionResponse> {
    public static final FunctionResponse$$serializer INSTANCE = new FunctionResponse$$serializer();
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.shared.FunctionResponse", INSTANCE, 2);
    ...
    public FunctionResponse deserialize(Decoder decoder) {
            ...
            while (z) {
                ...
                switch (decodeElementIndex) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        obj2 = beginStructure.decodeSerializableElement(descriptor2, 1, JsonObjectSerializer.INSTANCE, obj2);
                        i2 |= 2;
                        break;
                    default:
        ...
        return new FunctionResponse(i, str, (JsonObject) obj, null);
    }
    ...
    public void serialize(Encoder encoder, FunctionResponse value) {
        ...
        FunctionResponse.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
