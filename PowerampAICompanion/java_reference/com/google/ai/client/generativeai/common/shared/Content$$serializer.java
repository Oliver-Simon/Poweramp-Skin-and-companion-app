...
public final class Content$$serializer implements GeneratedSerializer<Content> {
    public static final Content$$serializer INSTANCE = new Content$$serializer();
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.shared.Content", INSTANCE, 2);
    ...
    public Content deserialize(Decoder decoder) {
        ...
        return new Content(i, (String) obj2, (List) obj, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, Content value) {
        ...
        Content.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
