...
public final class SerializersModuleBuilder implements SerializersModuleCollector {
    ...
    @Override // kotlinx.serialization.modules.SerializersModuleCollector
    public <T> void contextual(KClass<T> kClass, Function1<? super List<? extends KSerializer<?>>, ? extends KSerializer<?>> r9) {
        Intrinsics.checkNotNullParameter(kClass, "kClass");
        Intrinsics.checkNotNullParameter(r9, "provider");
        registerSerializer$default(this, kClass, new ContextualProvider.WithTypeArguments(r9), false, 4, null);
    }
    ...
    public final <T> void registerSerializer(KClass<T> forClass, ContextualProvider r6, boolean allowOverwrite) {
        ContextualProvider previous;
        Intrinsics.checkNotNullParameter(forClass, "forClass");
        Intrinsics.checkNotNullParameter(r6, "provider");
        if (!allowOverwrite && (previous = this.class2ContextualProvider.get(forClass)) != null && !Intrinsics.areEqual(previous, r6)) {
            throw new SerializerAlreadyRegisteredException("Contextual serializer or serializer provider for " + forClass + " already registered in this module");
        }
        this.class2ContextualProvider.put(forClass, r6);
    }
