...
final class ClassValueParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo2081getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                m510constructorimpl = Result.m510constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object putIfAbsent = access$getSerializers$p.putIfAbsent(arrayList2, m509boximpl);
