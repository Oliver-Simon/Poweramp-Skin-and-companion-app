...
public final class ComposerForUnsignedNumbers extends Composer {
    ...
    public void print(int v) {
        if (this.forceQuoting) {
            printQuoted(Integer.toUnsignedString(UInt.m605constructorimpl(v)));
        } else {
            print(Integer.toUnsignedString(UInt.m605constructorimpl(v)));
        }
    }
    ...
    public void print(long v) {
        if (this.forceQuoting) {
            printQuoted(Long.toUnsignedString(ULong.m684constructorimpl(v)));
        } else {
            print(Long.toUnsignedString(ULong.m684constructorimpl(v)));
        }
    }
    ...
    public void print(byte v) {
        if (this.forceQuoting) {
            printQuoted(UByte.m572toStringimpl(UByte.m528constructorimpl(v)));
        } else {
            print(UByte.m572toStringimpl(UByte.m528constructorimpl(v)));
        }
    }
    ...
    public void print(short v) {
        if (this.forceQuoting) {
            printQuoted(UShort.m835toStringimpl(UShort.m791constructorimpl(v)));
        } else {
            print(UShort.m835toStringimpl(UShort.m791constructorimpl(v)));
        }
    }
}
