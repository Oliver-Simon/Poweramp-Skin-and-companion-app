...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo2014receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m2012receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(th)));
        }
        ...
        try {
            switch (updateCellSend(channelSegment, index, e, s, cont, false)) {
                case 0:
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m510constructorimpl(Unit.INSTANCE));
                    break;
                case 1:
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m510constructorimpl(Unit.INSTANCE));
                    ...
                    while (true) {
                        ...
                        switch (updateCellSend(segment$iv$iv, i$iv$iv, e, s$iv$iv, cont2, closed$iv$iv)) {
                            case 0:
                                ...
                                cont2.resumeWith(Result.m510constructorimpl(Unit.INSTANCE));
                                break;
                            case 1:
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(exception$iv)));
    }

    /* JADX WARN: Failed to find 'out' block for switch in B:14:0x006b. Please report as an issue. */
    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2010trySendJP2dKIU(E element) {
        Object waiter$iv;
        ...
        while (true) {
            ...
            if (segment$iv2.id != id$iv) {
                ...
                if (segment$iv == null) {
                    if (closed$iv) {
                        return ChannelResult.INSTANCE.m2033closedJP2dKIU(getSendException());
                    }
                }
            } else {
            ...
            switch (updateCellSend(segment$iv, i$iv, element, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    return ChannelResult.INSTANCE.m2035successJP2dKIU(Unit.INSTANCE);
                case 1:
                    return ChannelResult.INSTANCE.m2035successJP2dKIU(Unit.INSTANCE);
                case 2:
                    if (closed$iv) {
        ...
        while (true) {
            ...
            if (segment$iv.id != id$iv) {
                ...
                if (findSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m510constructorimpl(Boxing.boxBoolean(false)));
                } else {
                    z = z2;
                }
            }
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, s$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m510constructorimpl(Boxing.boxBoolean(z2)));
                    break;
                case 1:
                    Result.Companion companion3 = Result.INSTANCE;
                    cont.resumeWith(Result.m510constructorimpl(Boxing.boxBoolean(z2)));
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult m2020boximpl = ChannelResult.m2020boximpl(ChannelResult.INSTANCE.m2035successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m2020boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
            return tryResume02;
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    public static /* synthetic */ <E> java.lang.Object m2012receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r13, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r14) {
        /*
            Method dump skipped, instructions count: 224
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m2012receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m2013receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r25, int r26, long r27, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r29) {
        /*
            Method dump skipped, instructions count: 452
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m2013receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m510constructorimpl(ChannelResult.m2020boximpl(ChannelResult.INSTANCE.m2033closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo2015tryReceivePtdJZtk() {
        Object waiter$iv;
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m2033closedJP2dKIU(getCloseCause());
        }
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != symbol2) {
                ...
                return ChannelResult.INSTANCE.m2035successJP2dKIU(updCellResult$iv);
            }
    ...
    public final void waitExpandBufferCompletion$kotlinx_coroutines_core(long globalIndex) {
        ...
        int i2 = 0;
        while (true) {
            long ebCompleted3 = DurationKt.MAX_MILLIS;
            if (i2 < i) {
                ...
                long ebCompleted4 = DurationKt.MAX_MILLIS & $this$ebCompletedCounter$iv;
                if (b == ebCompleted4 && b == bufferedChannel.getBufferEndCounter()) {
                    return;
                } else {
                    i2++;
                }
                ...
                while (true) {
                    long it2 = atomicfu$handler$iv.get(bufferedChannel);
                    long $this$ebCompletedCounter$iv2 = it2 & DurationKt.MAX_MILLIS;
                    it = BufferedChannelKt.constructEBCompletedAndPauseFlag($this$ebCompletedCounter$iv2, true);
                    if (atomicfu$handler$iv.compareAndSet(bufferedChannel, it2, it)) {
                        break;
                    } else {
                        bufferedChannel = this;
                    }
                ...
                while (true) {
                    ...
                    ebCompleted = ebCompletedAndBit & ebCompleted3;
                    int $i$f$getEbPauseExpandBuffers = (Longs.MAX_POWER_OF_TWO & ebCompletedAndBit) != 0 ? 1 : 0;
                    ...
                    if (i3 == 0) {
                        ...
                        constructEBCompletedAndPauseFlag = BufferedChannelKt.constructEBCompletedAndPauseFlag(ebCompleted, true);
                        bufferedChannel = this;
                ...
                while (true) {
                    long ebCompleted5 = ebCompleted;
                    long it3 = atomicfu$handler$iv2.get(bufferedChannel);
                    long j2 = ebCompleted3;
                    ebCompleted2 = BufferedChannelKt.constructEBCompletedAndPauseFlag(it3 & j2, false);
                    if (!atomicfu$handler$iv2.compareAndSet(bufferedChannel, it3, ebCompleted2)) {
                        bufferedChannel = this;
                        ebCompleted = ebCompleted5;
                        ebCompleted3 = j2;
                    } else {
                        return;
                    }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m2020boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m2033closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m2035successJP2dKIU(selectResult));
    }
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cont.resumeWith(Result.m510constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    public void mo2079invokeOnClose(Function1<? super Throwable, Unit> handler) {
        Symbol symbol;
        Symbol symbol2;
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Symbol symbol;
        Object suspendedReceivers = InlineList.m2057constructorimpl$default(null, 1, null);
                        ...
                        if (state != symbol) {
                            if (state instanceof WaiterEB) {
                                if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    suspendedReceivers = InlineList.m2062plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                                    segment.onCancelledRequest(index, true);
                                    break;
                                }
                            } else {
                                ...
                                if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    suspendedReceivers = InlineList.m2062plusFjFbRPM(suspendedReceivers, state);
                                    segment.onCancelledRequest(index, true);
                                    break;
                                }
                            }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m510constructorimpl(ChannelResult.m2020boximpl(ChannelResult.INSTANCE.m2033closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        while (true) {
            ...
            if (SegmentOrClosed.m2074isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m2072getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m2072getSegmentimpl(s$iv);
        if (segment.id > id) {
    ...
    public final String toStringDebug$kotlinx_coroutines_core() {
        ...
        while (true) {
            StringBuilder append2 = new StringBuilder().append(DebugStringsKt.getHexAddress(channelSegment2)).append("=[").append(channelSegment2.isRemoved() ? Marker.ANY_MARKER : "").append(channelSegment2.id).append(",prev=");
