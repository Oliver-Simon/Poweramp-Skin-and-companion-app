...
public interface SendChannel<E> {
    ...
    void mo2079invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo2010trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo2010trySendJP2dKIU(e);
            if (ChannelResult.m2030isSuccessimpl(result)) {
                return true;
            }
            Throwable m2024exceptionOrNullimpl = ChannelResult.m2024exceptionOrNullimpl(result);
