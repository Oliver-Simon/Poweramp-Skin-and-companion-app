...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (this.lastConflatedElement != BroadcastChannelKt.access$getNO_ELEMENT$p()) {
                s.mo2010trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo2010trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2010trySendJP2dKIU(element);
            }
            ...
            for (Object element$iv2 : $this$forEach$iv) {
                ...
                it3.mo2010trySendJP2dKIU(element);
            }
