...
public interface ReceiveChannel<E> {
    ...
    Object mo2014receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2015tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo2015tryReceivePtdJZtk = receiveChannel.mo2015tryReceivePtdJZtk();
            if (ChannelResult.m2030isSuccessimpl(mo2015tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2026getOrThrowimpl(mo2015tryReceivePtdJZtk);
            }
            Throwable m2024exceptionOrNullimpl = ChannelResult.m2024exceptionOrNullimpl(mo2015tryReceivePtdJZtk);
            if (m2024exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m2024exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L37:
                ...
                r2 = 1
                r0.label = r2
                java.lang.Object r3 = r3.mo2014receiveCatchingJP2dKIU(r0)
                if (r3 != r1) goto L44
                return r1
            L44:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m2025getOrNullimpl(r3)
                return r3
            */
