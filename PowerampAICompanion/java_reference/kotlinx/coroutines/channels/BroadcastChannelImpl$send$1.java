...
@DebugMetadata(c = "kotlinx.coroutines.channels.BroadcastChannelImpl", f = "BroadcastChannel.kt", i = {0, 0}, l = {PowerampAPI.Cats.COMPOSERS_ID_ALBUMS}, m = "send", n = {"this", "element"}, s = {"L$0", "L$1"})
