...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m2038trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m2024exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m2038trySendImplMj0NB7M(e, true);
    ...
    public Object mo2010trySendJP2dKIU(E element) {
        return m2038trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2038trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2036trySendDropLatestMj0NB7M(element, isSendOp) : m2037trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2036trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo2010trySendJP2dKIU(element);
        if (ChannelResult.m2030isSuccessimpl(result) || ChannelResult.m2028isClosedimpl(result)) {
            return result;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x00ec, code lost:
        ...
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m2035successJP2dKIU(kotlin.Unit.INSTANCE);
     */
    ...
    */
    private final java.lang.Object m2037trySendDropOldestJP2dKIU(E r20) {
        /*
            Method dump skipped, instructions count: 268
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.ConflatedBufferedChannel.m2037trySendDropOldestJP2dKIU(java.lang.Object):java.lang.Object");
    }
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object it = mo2010trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m2024exceptionOrNullimpl(it);
