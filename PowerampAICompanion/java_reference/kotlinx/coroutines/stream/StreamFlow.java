...
public final class StreamFlow<T> implements Flow<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x005a A[Catch: all -> 0x0077, TRY_LEAVE, TryCatch #0 {all -> 0x0077, blocks: (B:13:0x0039, B:15:0x0054, B:17:0x005a, B:28:0x004b), top: B:7:0x0022 }] */
