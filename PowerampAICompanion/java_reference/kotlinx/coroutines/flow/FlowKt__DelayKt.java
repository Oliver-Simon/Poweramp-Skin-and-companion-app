...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2043debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1999toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> m2044sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1999toDelayMillisLRDsOJo(period));
    }

    /* renamed from: timeout-HG0u8IE */
    public static final <T> Flow<T> m2045timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m2046timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt */
    private static final <T> Flow<T> m2046timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
