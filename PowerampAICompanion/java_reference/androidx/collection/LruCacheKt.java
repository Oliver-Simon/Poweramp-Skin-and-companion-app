...
public final class LruCacheKt {
    public static /* synthetic */ LruCache lruCache$default(int maxSize, Function2 sizeOf, Function1 create, Function4 onEntryRemoved, int i, Object obj) {
        Function2 sizeOf2;
        Function1 create2;
        Function4 onEntryRemoved2;
        if ((i & 2) != 0) {
            Function2 sizeOf3 = new Function2<K, V, Integer>() { // from class: androidx.collection.LruCacheKt$lruCache$1
        ...
        if ((i & 4) == 0) {
            ...
            Function1 create3 = new Function1<K, V>() { // from class: androidx.collection.LruCacheKt$lruCache$2
        ...
        if ((i & 8) == 0) {
            onEntryRemoved2 = onEntryRemoved;
        } else {
            Function4 onEntryRemoved3 = new Function4<Boolean, K, V, V, Unit>() { // from class: androidx.collection.LruCacheKt$lruCache$3
                /* JADX WARN: Multi-variable type inference failed */
            ...
            onEntryRemoved2 = onEntryRemoved3;
        }
        Intrinsics.checkParameterIsNotNull(sizeOf2, "sizeOf");
        Intrinsics.checkParameterIsNotNull(create2, "create");
        Intrinsics.checkParameterIsNotNull(onEntryRemoved2, "onEntryRemoved");
        return new LruCacheKt$lruCache$4(sizeOf2, create2, onEntryRemoved2, maxSize, maxSize);
    }
