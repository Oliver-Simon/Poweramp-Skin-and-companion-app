                ...
                case 0:
                    ...
                    ?? r8 = new InvalidationTracker.Observer(strArr) { // from class: androidx.room.CoroutinesRoom$Companion$createFlow$1$1$observer$1
                        ...
                        public void onInvalidated(Set<String> tables) {
                            ...
                            observerChannel.mo2010trySendJP2dKIU(Unit.INSTANCE);
                        }
                    };
                    observerChannel.mo2010trySendJP2dKIU(Unit.INSTANCE);
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, queryContext, null, new C00061(this.$db, r8, observerChannel, this.$callable, resultChannel, null), 2, null);
                    this.label = 1;
