...
public class Person {
    ...
    static class Api22Impl {
        ...
        static Person fromPersistableBundle(PersistableBundle bundle) {
            return new Builder().setName(bundle.getString("name")).setUri(bundle.getString("uri")).setKey(bundle.getString(Person.KEY_KEY)).setBot(bundle.getBoolean(Person.IS_BOT_KEY)).setImportant(bundle.getBoolean(Person.IS_IMPORTANT_KEY)).build();
        }
        ...
        static PersistableBundle toPersistableBundle(Person person) {
            ...
            result.putString("uri", person.mUri);
