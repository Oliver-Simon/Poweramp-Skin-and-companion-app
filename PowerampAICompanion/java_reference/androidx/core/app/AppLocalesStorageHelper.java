...
public class AppLocalesStorageHelper {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x005b, code lost:
        ...
        if (r2 == null) goto L35;
     */
    /* JADX WARN: Not initialized variable reg: 2, insn: 0x006c: IF  (r2 I:??[int, boolean, OBJECT, ARRAY, byte, short, char] A[D('fis' java.io.FileInputStream)]) == (0 ??[int, boolean, OBJECT, ARRAY, byte, short, char])  -> B:57:0x0074 (LINE:95), block:B:56:0x006c */
    /*
