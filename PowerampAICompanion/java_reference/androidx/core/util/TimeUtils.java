...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        int start = days;
        int pos3 = printField(formatStr, start, GMTDateParser.DAY_OF_MONTH, pos2, false, 0);
        boolean z = pos3 != pos2;
        if (zeropad) {
            i = 2;
        } else {
        ...
        int pos4 = printField(formatStr, hours, GMTDateParser.HOURS, pos3, z, i);
        ...
        int pos5 = printField(formatStr, minutes, GMTDateParser.MINUTES, pos4, z2, i2);
        ...
        int pos6 = printField(formatStr, seconds, GMTDateParser.SECONDS, pos5, z3, i3);
        int pos7 = printField(formatStr, millis, GMTDateParser.MINUTES, pos6, true, (!zeropad || pos6 == pos2) ? 0 : 3);
        formatStr[pos7] = GMTDateParser.SECONDS;
        return pos7 + 1;
    }
