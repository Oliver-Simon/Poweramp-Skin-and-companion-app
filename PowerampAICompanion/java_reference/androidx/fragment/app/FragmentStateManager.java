...
public class FragmentStateManager {
    ...
    public FragmentStateManager(FragmentLifecycleCallbacksDispatcher dispatcher, FragmentStore fragmentStore, ClassLoader classLoader, FragmentFactory fragmentFactory, Bundle state) {
        this.mDispatcher = dispatcher;
        this.mFragmentStore = fragmentStore;
        FragmentState fs = (FragmentState) state.getParcelable("state");
    ...
    public void restoreState(ClassLoader classLoader) {
        ...
        FragmentState fs = (FragmentState) this.mFragment.mSavedFragmentState.getParcelable("state");
        if (fs != null) {
    ...
    void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "requestFocus: Restoring focused view " + focusedView + " " + (success ? "succeeded" : PowerampAPI.FAILED) + " on Fragment " + this.mFragment + " resulting in focused view " + this.mFragment.mView.findFocus());
            }
        }
    ...
    public Bundle saveState() {
        ...
        stateBundle.putParcelable("state", fs);
