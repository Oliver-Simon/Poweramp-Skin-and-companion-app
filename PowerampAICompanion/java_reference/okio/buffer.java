...
public final class buffer implements BufferedSource {
    ...
    public String readUtf8LineStrict(long limit) {
        ...
        if (scanLength$iv < Long.MAX_VALUE && request(scanLength$iv) && this.bufferField.getByte(scanLength$iv - 1) == ((byte) 13) && request(scanLength$iv + 1) && this.bufferField.getByte(scanLength$iv) == b) {
