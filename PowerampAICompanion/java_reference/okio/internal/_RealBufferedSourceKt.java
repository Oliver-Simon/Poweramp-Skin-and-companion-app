...
public final class _RealBufferedSourceKt {
    ...
    public static final String commonReadUtf8LineStrict(buffer $this$commonReadUtf8LineStrict, long limit) {
        ...
        if (scanLength < Long.MAX_VALUE && $this$commonReadUtf8LineStrict.request(scanLength) && $this$commonReadUtf8LineStrict.bufferField.getByte(scanLength - 1) == ((byte) 13) && $this$commonReadUtf8LineStrict.request(scanLength + 1) && $this$commonReadUtf8LineStrict.bufferField.getByte(scanLength) == b) {
