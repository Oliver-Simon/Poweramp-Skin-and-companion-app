...
public final class _BufferKt {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:52:0x0117, code lost:
        ...
        throw new java.lang.NumberFormatException(r4 + " but was 0x" + okio._UtilKt.toHexString(r22.getByte(r16)));
     */
    ...
    */
    ...
    public static final int commonReadUtf8CodePoint(Buffer $this$commonReadUtf8CodePoint) {
        ...
        if ($this$commonReadUtf8CodePoint.size() < codePoint) {
            throw new EOFException("size < " + codePoint + ": " + $this$commonReadUtf8CodePoint.size() + " (to read code point prefixed 0x" + _UtilKt.toHexString(b0) + ')');
        }
        ...
        if (targetBytes.size() == 2) {
            ...
            while (offset4 < buffer.size()) {
                ...
                while (b3 < limit3) {
                    int pos8 = b3;
                    int pos9 = data4[pos8];
                    if (pos9 == b02 || pos9 == b12) {
                        int b4 = s4.pos;
                        return (pos8 - b4) + offset4;
                    }
                    b3 = pos8 + 1;
                }
                int pos10 = s4.limit;
                offset4 += pos10 - s4.pos;
                fromIndex4 = offset4;
            ...
            while (offset4 < $this$commonIndexOfElement.size()) {
                byte[] data5 = s5.data;
                int pos11 = (int) ((s5.pos + fromIndex5) - offset4);
                int limit4 = s5.limit;
                while (pos11 < limit4) {
                    byte b5 = data5[pos11];
                    Buffer $this$seek$iv2 = $this$seek$iv;
