...
public final class _FileSystemKt$commonListRecursively$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        while (it.hasNext()) {
            ...
            if (_FileSystemKt.collectRecursively($this$sequence, _filesystemkt_commonlistrecursively_1.$this_commonListRecursively, stack, child, _filesystemkt_commonlistrecursively_1.$followSymlinks, false, _filesystemkt_commonlistrecursively_1) == coroutine_suspended) {
