...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer writeTo(OutputStream out, long byteCount) throws IOException {
        Intrinsics.checkNotNullParameter(out, "out");
        long byteCount2 = byteCount;
        _UtilKt.checkOffsetAndCount(this.size, 0L, byteCount2);
        Segment s = this.head;
        while (byteCount2 > 0) {
            Intrinsics.checkNotNull(s);
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:40:0x00bb A[EDGE_INSN: B:40:0x00bb->B:37:0x00bb BREAK  A[LOOP:0: B:4:0x0011->B:39:?], SYNTHETIC] */
    ...
    */
    public long readHexadecimalUnsignedLong() throws java.io.EOFException {
        ...
        L8a:
            ...
            java.lang.String r14 = okio._UtilKt.toHexString(r13)
            java.lang.StringBuilder r5 = r5.append(r14)
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (size() < codePoint$iv) {
            throw new EOFException("size < " + codePoint$iv + ": " + size() + " (to read code point prefixed 0x" + _UtilKt.toHexString(b0$iv) + ')');
        }
    ...
    public Buffer write(byte[] source, int offset, int byteCount) {
        ...
        _UtilKt.checkOffsetAndCount(source.length, offset$iv, byteCount);
    ...
    public void write(Buffer source, long byteCount) {
        ...
        _UtilKt.checkOffsetAndCount(source.size(), 0L, byteCount$iv);
        while (byteCount$iv > 0) {
    ...
    public long indexOf(ByteString bytes, long fromIndex) throws IOException {
        ...
        if ($this$seek$iv$iv.size() - fromIndex$iv < fromIndex$iv) {
            ...
            while (offset$iv2 < resultLimit$iv) {
                ...
                for (int pos$iv = (int) ((s$iv2.pos + fromIndex$iv2) - offset$iv2); pos$iv < a$iv$iv2; pos$iv++) {
                    if (data$iv[pos$iv] == b0$iv && _BufferKt.rangeEquals(s$iv2, pos$iv + 1, targetByteArray$iv, 1, bytesSize$iv)) {
                        return (pos$iv - s$iv2.pos) + offset$iv2;
                    }
                }
        ...
        while (offset$iv4 < resultLimit$iv2) {
            ...
            for (int pos$iv3 = (int) ((s$iv5.pos + fromIndex$iv) - offset$iv4); pos$iv3 < segmentLimit$iv; pos$iv3++) {
                if (data$iv2[pos$iv3] == b0$iv2 && _BufferKt.rangeEquals(s$iv5, pos$iv3 + 1, targetByteArray$iv2, 1, bytesSize$iv2)) {
    ...
    public final byte m2260deprecated_getByte(long index) {
