...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m678boximpl(ULong.m684constructorimpl(getMostSignificantBits())), ULong.m678boximpl(ULong.m684constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1994toUByteArrayTcUX1vc() {
        return UByteArray.m581constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m684constructorimpl(this.mostSignificantBits), ULong.m684constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m684constructorimpl(this.leastSignificantBits), ULong.m684constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1995fromUByteArrayGBYM_sE(byte[] ubyteArray) {
