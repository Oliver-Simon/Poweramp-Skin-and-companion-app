...
public final class UMathKt {
    ...
    private static final int m1730minJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1709minOfJ1ME1BU(a, b);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1731mineb3DHEI(long a, long b) {
        return UComparisonsKt.m1717minOfeb3DHEI(a, b);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1728maxJ1ME1BU(int a, int b) {
        return UComparisonsKt.m1697maxOfJ1ME1BU(a, b);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1729maxeb3DHEI(long a, long b) {
        return UComparisonsKt.m1705maxOfeb3DHEI(a, b);
    }
}
