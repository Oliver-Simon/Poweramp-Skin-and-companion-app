...
public final class UStringsKt {
    ...
    public static final String m1842toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1844toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1843toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1841toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m605constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m522boximpl(UByte.m528constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m605constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m785boximpl(UShort.m791constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m605constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m605constructorimpl(result * uradix);
            result = UInt.m605constructorimpl(UInt.m605constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m599boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m684constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m684constructorimpl(result * uradix);
            result = ULong.m684constructorimpl(ULong.m684constructorimpl(UInt.m605constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m678boximpl(result);
    }
}
