...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1971boximpl(m1965markNowz9LOYto());
    }
    ...
    public long m1965markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1974constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1964elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1963differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1962adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1974constructorimpl(LongSaturatedMathKt.m1960saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
