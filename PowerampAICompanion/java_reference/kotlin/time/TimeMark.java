...
public interface TimeMark {
    ...
    TimeMark mo1846minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1848plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1969plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1968minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1848plusLRDsOJo(Duration.m1899unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1881isNegativeimpl($this.mo1845elapsedNowUwyO8pc());
        }
