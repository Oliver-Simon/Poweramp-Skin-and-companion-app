...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1846minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1968minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1845elapsedNowUwyO8pc() {
        return Duration.m1883minusLRDsOJo(this.mark.mo1845elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1848plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1884plusLRDsOJo(this.adjustment, duration), null);
    }
}
