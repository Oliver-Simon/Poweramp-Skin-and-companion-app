...
public final class InstantKt {
    ...
    private static final int[] POWERS_OF_TEN = {1, 10, 100, 1000, TableDefs.Files.INVALID_TRACK_NUMBER, 100000, 1000000, 10000000, 100000000, 1000000000};
    ...
    /* JADX WARN: Removed duplicated region for block: B:133:0x029a A[LOOP:4: B:124:0x0274->B:133:0x029a, LOOP_END] */
    ...
    */
    ...
    public static final String formatIso(Instant instant) {
        ...
        if (Math.abs(number) < 1000) {
            ...
            if (number >= 0) {
                Intrinsics.checkNotNullExpressionValue(innerBuilder.append(number + TableDefs.Files.INVALID_TRACK_NUMBER).deleteCharAt(0), "deleteCharAt(...)");
            } else {
        ...
        $this$formatIso_u24lambda_u248.append(AbstractJsonLexerKt.COLON);
