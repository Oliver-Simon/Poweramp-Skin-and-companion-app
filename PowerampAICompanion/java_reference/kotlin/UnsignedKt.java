...
public final class UnsignedKt {
    ...
    public static final int m862uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m605constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m861uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m605constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m863ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m684constructorimpl(Long.compareUnsigned(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m684constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m684constructorimpl((Long.compareUnsigned(ULong.m684constructorimpl(rem), ULong.m684constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m864ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compareUnsigned(ULong.m684constructorimpl(rem), ULong.m684constructorimpl(v2)) >= 0) {
            j = v2;
        }
        return ULong.m684constructorimpl(rem - j);
    }
    ...
    private static final long uintToULong(int value) {
        return ULong.m684constructorimpl(value & 4294967295L);
    }
    ...
    public static final int doubleToUInt(double value) {
        ...
        return value <= 2.147483647E9d ? UInt.m605constructorimpl((int) value) : UInt.m605constructorimpl(UInt.m605constructorimpl((int) (value - Integer.MAX_VALUE)) + UInt.m605constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double value) {
        ...
        return value < 9.223372036854776E18d ? ULong.m684constructorimpl((long) value) : ULong.m684constructorimpl(ULong.m684constructorimpl((long) (value - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
