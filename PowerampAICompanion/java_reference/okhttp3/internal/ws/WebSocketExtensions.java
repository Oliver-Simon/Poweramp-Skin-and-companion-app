    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers responseHeaders) throws IOException {
            ...
            while (i < size) {
                ...
                i++;
                boolean z = true;
                if (StringsKt.equals(responseHeaders2.name(i2), "Sec-WebSocket-Extensions", true)) {
                    String header = responseHeaders2.value(i2);
                    int pos = 0;
                    while (pos < header.length()) {
                        int pos2 = pos;
                        int extensionEnd2 = Util.delimiterOffset$default(header, AbstractJsonLexerKt.COMMA, pos2, 0, 4, (Object) null);
                        ...
                        if (StringsKt.equals(extensionToken, "permessage-deflate", z)) {
                            ...
                            while (pos3 < extensionEnd2) {
                                int parameterEnd = Util.delimiterOffset(header2, ';', pos3, extensionEnd2);
