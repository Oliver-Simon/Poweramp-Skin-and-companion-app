...
public final class PublicSuffixDatabase {
    ...
    private final List<String> findMatchingRule(List<String> domainLabels) {
        ...
        List wildcardRuleLabels = wildcardMatch != null ? StringsKt.split$default((CharSequence) wildcardMatch, new char[]{'.'}, false, 0, 6, (Object) null) : null;
        if (wildcardRuleLabels == null) {
