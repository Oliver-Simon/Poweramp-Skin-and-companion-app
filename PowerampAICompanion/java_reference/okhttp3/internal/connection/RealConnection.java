    ...
    */
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            if (connectionSpec.supportsTlsExtensions()) {
                maybeProtocol = Platform.INSTANCE.get().getSelectedProtocol(sslSocket);
            }
