...
public final class Relay {
    ...
    public final void writeHeader(ByteString prefix, long upstreamSize, long metadataSize) throws IOException {
        ...
        fileOperator.write(0L, $this$writeHeader_u24lambda_u2d0, FILE_HEADER_SIZE);
    }
        ...
        public long read(Buffer sink, long byteCount) throws IOException {
            ...
            synchronized (relay) {
                while (true) {
                    ...
                    if (this.sourcePos == upstreamPos) {
                        ...
                        if (this.sourcePos >= bufferPos) {
                            ...
                            relay2.getBuffer().copyTo(sink2, this.sourcePos - bufferPos, bytesToRead);
                ...
                try {
                    ...
                    this.this$0.getUpstreamBuffer().copyTo(sink, 0L, bytesRead);
