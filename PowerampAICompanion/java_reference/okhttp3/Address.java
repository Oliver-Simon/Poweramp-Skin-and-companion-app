...
public final class Address {
    ...
    public final List<Protocol> m2128deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m2125deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public String toString() {
        String str;
        Object obj;
        StringBuilder append = new StringBuilder().append("Address{").append(this.url.host()).append(AbstractJsonLexerKt.COLON).append(this.url.port()).append(", ");
        if (this.proxy != null) {
            str = "proxy=";
            obj = this.proxy;
        } else {
        ...
        return append.append(Intrinsics.stringPlus(str, obj)).append(AbstractJsonLexerKt.END_OBJ).toString();
    }
}
