...
public final class MediaType {
    ...
    public final Charset charset(Charset defaultValue) {
        String charset = parameter(HttpAuthHeader.Parameters.Charset);
        if (charset == null) {
            return defaultValue;
        }
        try {
    ...
    public static final class Companion {
        ...
        */
        ...
        public final MediaType m2200deprecated_get(String mediaType) {
        ...
        public final MediaType m2201deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
