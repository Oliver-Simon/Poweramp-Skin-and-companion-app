...
public final class PacketKt {
    ...
    public static final boolean isEmpty(Input $this$isEmpty) {
        Intrinsics.checkNotNullParameter($this$isEmpty, "<this>");
        return $this$isEmpty.getEndOfInput();
    }

    public static final boolean isNotEmpty(Input $this$isNotEmpty) {
        ChunkBuffer found;
        Intrinsics.checkNotNullParameter($this$isNotEmpty, "<this>");
        if ($this$isNotEmpty.getEndOfInput() || (found = UnsafeKt.prepareReadFirstHead($this$isNotEmpty, 1)) == null) {
            return false;
        }
        UnsafeKt.completeReadHead($this$isNotEmpty, found);
        return true;
    }

    public static final boolean isEmpty(ByteReadPacket $this$isEmpty) {
        Intrinsics.checkNotNullParameter($this$isEmpty, "<this>");
        return $this$isEmpty.getEndOfInput();
    }

    public static final boolean isNotEmpty(ByteReadPacket $this$isNotEmpty) {
        Intrinsics.checkNotNullParameter($this$isNotEmpty, "<this>");
        return !$this$isNotEmpty.getEndOfInput();
    }
}
