...
public final class OutputKt {
    ...
    public static final Output asOutput(WritableByteChannel $this$asOutput, ObjectPool<ChunkBuffer> pool) {
        Intrinsics.checkNotNullParameter($this$asOutput, "<this>");
        Intrinsics.checkNotNullParameter(pool, "pool");
        return new ChannelAsOutput(pool, $this$asOutput);
    }
}
