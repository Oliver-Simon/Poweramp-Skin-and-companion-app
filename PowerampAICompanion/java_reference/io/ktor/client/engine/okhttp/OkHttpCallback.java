...
public final class OkHttpCallback implements Callback {
    ...
    public void onFailure(Call call, IOException e) {
        ...
        cancellableContinuation.resumeWith(Result.m510constructorimpl(ResultKt.createFailure(mapOkHttpException)));
    }
    ...
    public void onResponse(Call call, Response response) {
        ...
        if (!call.getCanceled()) {
            CancellableContinuation<Response> cancellableContinuation = this.continuation;
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuation.resumeWith(Result.m510constructorimpl(response));
        }
    }
}
