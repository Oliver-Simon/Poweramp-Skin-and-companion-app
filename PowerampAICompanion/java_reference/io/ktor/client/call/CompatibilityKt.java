...
public final class CompatibilityKt {
    ...
    public static final /* synthetic */ <T> Object receive(HttpClientCall $this$receive, Continuation<? super T> continuation) {
        throw new IllegalStateException("Use `body` method instead".toString());
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "Use `body` method instead", replaceWith = @ReplaceWith(expression = "this.body<T>()", imports = {}))
    public static final /* synthetic */ <T> Object receive(HttpResponse $this$receive, Continuation<? super T> continuation) {
        throw new IllegalStateException("Use `body` method instead".toString());
    }
    ...
    public static final Object receive(HttpClientCall $this$receive, TypeInfo info, Continuation<Object> continuation) {
        throw new IllegalStateException("Use `body` method instead".toString());
    }
}
