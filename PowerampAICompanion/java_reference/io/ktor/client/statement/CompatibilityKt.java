...
public final class CompatibilityKt {
    ...
    public static final /* synthetic */ <T> Object receive(HttpStatement $this$receive, Continuation<? super T> continuation) {
        throw new IllegalStateException("Use `body` method instead".toString());
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "Use `body` method instead", replaceWith = @ReplaceWith(expression = "this.body<T>()", imports = {}))
    public static final /* synthetic */ <T, R> Object receive(HttpStatement $this$receive, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        throw new IllegalStateException("Use `body` method instead".toString());
    }
    ...
    public static final Object readText(HttpResponse $this$readText, Charset fallbackCharset, Continuation<? super String> continuation) {
