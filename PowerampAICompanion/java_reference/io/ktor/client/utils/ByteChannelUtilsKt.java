...
public final class ByteChannelUtilsKt {
    public static final ByteReadChannel observable(ByteReadChannel $this$observable, CoroutineContext context, Long contentLength, Function3<? super Long, ? super Long, ? super Continuation<? super Unit>, ? extends Object> listener) {
        Intrinsics.checkNotNullParameter($this$observable, "<this>");
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(listener, "listener");
        return CoroutinesKt.writer((CoroutineScope) GlobalScope.INSTANCE, context, true, (Function2<? super WriterScope, ? super Continuation<? super Unit>, ? extends Object>) new ByteChannelUtilsKt$observable$1(contentLength, $this$observable, listener, null)).getChannel();
    }
}
