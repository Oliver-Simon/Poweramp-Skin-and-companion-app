...
public final class HttpRedirect {
    ...
    private HttpRedirect(boolean checkHttpMethod, boolean allowHttpsDowngrade) {
        this.checkHttpMethod = checkHttpMethod;
    ...
    public static final class Companion implements HttpClientPlugin<Config, HttpRedirect> {
        ...
        /* JADX WARN: Type inference failed for: r0v9, types: [T, io.ktor.client.request.HttpRequestBuilder] */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:33:0x01c3 -> B:12:0x01c7). Please report as a decompilation issue!!! */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct add '--show-bad-code' argument
        */
        public final java.lang.Object handleCall(io.ktor.client.plugins.Sender r17, io.ktor.client.request.HttpRequestBuilder r18, io.ktor.client.call.HttpClientCall r19, boolean r20, io.ktor.client.HttpClient r21, kotlin.coroutines.Continuation<? super io.ktor.client.call.HttpClientCall> r22) {
            /*
