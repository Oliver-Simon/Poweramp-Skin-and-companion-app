...
public final class HttpTimeoutKt {
    ...
    public static final void timeout(HttpRequestBuilder $this$timeout, Function1<? super HttpTimeout.HttpTimeoutCapabilityConfiguration, Unit> block) {
        ...
        $this$timeout.setCapability(companion, httpTimeoutCapabilityConfiguration);
    }
    ...
    public static final ConnectTimeoutException ConnectTimeoutException(HttpRequestData request, Throwable cause) {
        ...
        return new ConnectTimeoutException(append.append(obj).append(" ms]").toString(), cause);
    }
    ...
    public static final ConnectTimeoutException ConnectTimeoutException(String url, Long timeout, Throwable cause) {
        ...
        return new ConnectTimeoutException("Connect timeout has expired [url=" + url + ", connect_timeout=" + (timeout == null ? EnvironmentCompat.MEDIA_UNKNOWN : timeout) + " ms]", cause);
    }
    ...
    public static final SocketTimeoutException SocketTimeoutException(HttpRequestData request, Throwable cause) {
        ...
        return new SocketTimeoutException(append.append(obj).append("] ms").toString(), cause);
    }
