...
public final class CoroutinesUtilsKt {
    ...
    public static final CoroutineContext SilentSupervisor(Job parent) {
        return SupervisorKt.SupervisorJob(parent).plus(new CoroutinesUtilsKt$SilentSupervisor$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.INSTANCE));
    }
}
