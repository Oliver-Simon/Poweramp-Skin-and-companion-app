...
public final class EncodersJvmKt {
    ...
    private static final Encoder Deflate = new Encoder() { // from class: io.ktor.util.EncodersJvmKt$Deflate$1
        ...
        public ByteReadChannel encode(CoroutineScope $this$encode, ByteReadChannel source) {
            Intrinsics.checkNotNullParameter($this$encode, "<this>");
            Intrinsics.checkNotNullParameter(source, "source");
            return DeflaterKt.deflated$default(source, true, (ObjectPool) null, $this$encode.getCoroutineContext(), 2, (Object) null);
        }

        @Override // io.ktor.util.Encoder
        public ByteReadChannel decode(CoroutineScope $this$decode, ByteReadChannel source) {
            ByteReadChannel inflate;
            Intrinsics.checkNotNullParameter($this$decode, "<this>");
            Intrinsics.checkNotNullParameter(source, "source");
            inflate = EncodersJvmKt.inflate($this$decode, source, false);
            return inflate;
        }
    };
    private static final Encoder GZip = new Encoder() { // from class: io.ktor.util.EncodersJvmKt$GZip$1
        ...
        public ByteReadChannel decode(CoroutineScope $this$decode, ByteReadChannel source) {
            Intrinsics.checkNotNullParameter($this$decode, "<this>");
            Intrinsics.checkNotNullParameter(source, "source");
            return EncodersJvmKt.inflate$default($this$decode, source, false, 2, null);
        }
    };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ByteReadChannel inflate(CoroutineScope $this$inflate, ByteReadChannel source, boolean gzip) {
        return CoroutinesKt.writer$default($this$inflate, (CoroutineContext) null, false, (Function2) new EncodersJvmKt$inflate$1(gzip, source, null), 3, (Object) null).getChannel();
    }
