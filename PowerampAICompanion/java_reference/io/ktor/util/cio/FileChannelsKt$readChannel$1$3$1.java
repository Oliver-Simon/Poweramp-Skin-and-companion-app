...
public final class FileChannelsKt$readChannel$1$3$1 extends SuspendLambda implements Function2<WriterSuspendSession, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        FileChannelsKt$readChannel$1$3$1 fileChannelsKt$readChannel$1$3$1;
        WriterSuspendSession $this$writeSuspendSession;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (this.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                fileChannelsKt$readChannel$1$3$1 = this;
                $this$writeSuspendSession = (WriterSuspendSession) fileChannelsKt$readChannel$1$3$1.L$0;
                break;
            case 1:
                fileChannelsKt$readChannel$1$3$1 = this;
                $this$writeSuspendSession = (WriterSuspendSession) fileChannelsKt$readChannel$1$3$1.L$0;
        ...
        while (true) {
            ChunkBuffer buffer = $this$writeSuspendSession.request(1);
            if (buffer == null) {
                fileChannelsKt$readChannel$1$3$1.$$this$writer.getChannel().flush();
                fileChannelsKt$readChannel$1$3$1.L$0 = $this$writeSuspendSession;
                fileChannelsKt$readChannel$1$3$1.label = 1;
                if ($this$writeSuspendSession.tryAwait(1, fileChannelsKt$readChannel$1$3$1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                int rc = BufferViewJvmKt.read(fileChannelsKt$readChannel$1$3$1.$fileChannel, buffer);
                if (rc != -1) {
                    $this$writeSuspendSession.written(rc);
                } else {
