...
public final class EventsKt {
    ...
    public static final <T> void raiseCatching(Events $this$raiseCatching, EventDefinition<T> definition, T t, Logger logger) {
        Intrinsics.checkNotNullParameter($this$raiseCatching, "<this>");
        Intrinsics.checkNotNullParameter(definition, "definition");
        try {
            $this$raiseCatching.raise(definition, t);
