...
public interface ContentConverter {
    ...
    public static final class DefaultImpls {
        @Deprecated(level = DeprecationLevel.WARNING, message = "Please override and use serializeNullable instead", replaceWith = @ReplaceWith(expression = "serializeNullable(charset, typeInfo, contentType, value)", imports = {}))
        public static Object serialize(ContentConverter $this, ContentType contentType, Charset charset, TypeInfo typeInfo, Object value, Continuation<? super OutgoingContent> continuation) {
            return $this.serializeNullable(contentType, charset, typeInfo, value, continuation);
        }

        public static Object serializeNullable(ContentConverter $this, ContentType contentType, Charset charset, TypeInfo typeInfo, Object value, Continuation<? super OutgoingContent> continuation) {
            Intrinsics.checkNotNull(value);
            return $this.serialize(contentType, charset, typeInfo, value, continuation);
        }
    }
}
