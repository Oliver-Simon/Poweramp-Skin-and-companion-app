    ...
    public enum Codes {
        ...
        static {
            ...
            for (Codes codes : values) {
                destination$iv$iv.put(Short.valueOf(codes.code), codes);
            }
