...
public abstract class Protection {
    ...
    public void animateAlpha(float toAlpha) {
        ...
        this.mUserAlphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.insets.Protection$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                Protection.this.m65lambda$animateAlpha$0$androidxcoreviewinsetsProtection(valueAnimator);
            }
        });
    ...
    public /* synthetic */ void m65lambda$animateAlpha$0$androidxcoreviewinsetsProtection(ValueAnimator animation) {
    ...
    public void animateInsetsAmount(float toInsetsAmount) {
        ...
        this.mUserInsetAmountAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.insets.Protection$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                Protection.this.m66x124db077(valueAnimator);
            }
        });
    ...
    public /* synthetic */ void m66x124db077(ValueAnimator animation) {
        setAlphaInternal(((Float) animation.getAnimatedValue()).floatValue());
    }
    ...
    public static class Attributes {
        ...
        public interface Callback {
            ...
            public final /* synthetic */ class CC {
                public static void $default$onWidthChanged(Callback _this, int width) {
                }

                public static void $default$onHeightChanged(Callback _this, int height) {
                }

                public static void $default$onMarginChanged(Callback _this, Insets margin) {
                }

                public static void $default$onVisibilityChanged(Callback _this, boolean visible) {
                }

                public static void $default$onDrawableChanged(Callback _this, Drawable drawable) {
                }

                public static void $default$onTranslationXChanged(Callback _this, float translationX) {
                }

                public static void $default$onTranslationYChanged(Callback _this, float translationY) {
                }

                public static void $default$onAlphaChanged(Callback _this, float alpha) {
                }
            }
        }
