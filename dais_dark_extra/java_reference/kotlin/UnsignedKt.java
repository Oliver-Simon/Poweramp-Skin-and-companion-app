...
public final class UnsignedKt {
    ...
    public static final int m447uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m190constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m446uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m190constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m448ulongDivideeb3DHEI(long v1, long v2) {
        int compare;
        int compare2;
        if (v2 < 0) {
            compare2 = Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE);
            return ULong.m269constructorimpl(compare2 >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m269constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        compare = Long.compare(ULong.m269constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m269constructorimpl(v2) ^ Long.MIN_VALUE);
        return ULong.m269constructorimpl((compare < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m449ulongRemaindereb3DHEI(long v1, long v2) {
        int compare;
        int compare2;
        long j = 0;
        if (v2 < 0) {
        ...
        return ULong.m269constructorimpl(rem - j);
    }
    ...
    private static final long uintToULong(int value) {
        return ULong.m269constructorimpl(value & 4294967295L);
    }
    ...
    public static final int doubleToUInt(double value) {
        ...
        return value <= 2.147483647E9d ? UInt.m190constructorimpl((int) value) : UInt.m190constructorimpl(UInt.m190constructorimpl((int) (value - Integer.MAX_VALUE)) + UInt.m190constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double value) {
        ...
        return value < 9.223372036854776E18d ? ULong.m269constructorimpl((long) value) : ULong.m269constructorimpl(ULong.m269constructorimpl((long) (value - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
