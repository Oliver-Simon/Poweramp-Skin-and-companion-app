...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1556boximpl(m1550markNowz9LOYto());
    }
    ...
    public long m1550markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1559constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1549elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1548differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1547adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1559constructorimpl(LongSaturatedMathKt.m1545saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
