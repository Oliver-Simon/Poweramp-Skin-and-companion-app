...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1431minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1553minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1430elapsedNowUwyO8pc() {
        return Duration.m1468minusLRDsOJo(this.mark.mo1430elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1433plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1469plusLRDsOJo(this.adjustment, duration), null);
    }
}
