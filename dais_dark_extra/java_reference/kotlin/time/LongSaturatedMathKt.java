...
public final class LongSaturatedMathKt {
    ...
    public static final long m1545saturatingAddNuflL3o(long value, DurationUnit unit, long duration) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long durationInUnit = Duration.m1479toLongimpl(duration, unit);
        if (((value - 1) | 1) == Long.MAX_VALUE) {
            return m1544checkInfiniteSumDefinedPjuGub4(value, duration, durationInUnit);
        }
        if (((durationInUnit - 1) | 1) == Long.MAX_VALUE) {
            return m1546saturatingAddInHalvesNuflL3o(value, unit, duration);
        }
    ...
    private static final long m1544checkInfiniteSumDefinedPjuGub4(long value, long duration, long durationInUnit) {
    ...
    private static final long m1546saturatingAddInHalvesNuflL3o(long value, DurationUnit unit, long duration) {
        long half = Duration.m1443divUwyO8pc(duration, 2);
        long halfInUnit = Duration.m1479toLongimpl(half, unit);
        if (!((1 | (halfInUnit - 1)) == Long.MAX_VALUE)) {
            return m1545saturatingAddNuflL3o(m1545saturatingAddNuflL3o(value, unit, half), unit, Duration.m1468minusLRDsOJo(duration, half));
        }
        return halfInUnit;
    }
    ...
    private static final long infinityOfSign(long value) {
        ...
        return value < 0 ? companion.m1530getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m1529getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long valueNs, long origin, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (origin - 1)) == Long.MAX_VALUE) {
            return Duration.m1484unaryMinusUwyO8pc(infinityOfSign(origin));
        }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ($i$f$isSaturated != 0) {
            return origin1 == origin2 ? Duration.INSTANCE.m1531getZEROUwyO8pc() : Duration.m1484unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
    ...
    private static final long saturatingFiniteDiff(long value1, long value2, DurationUnit unit) {
        ...
        if (((result ^ value1) & (~(result ^ value2))) < 0) {
            if (unit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                Duration.Companion companion = Duration.INSTANCE;
                return Duration.m1469plusLRDsOJo(DurationKt.toDuration(resultMs, DurationUnit.MILLISECONDS), DurationKt.toDuration(resultUnit, unit));
            }
            return Duration.m1484unaryMinusUwyO8pc(infinityOfSign(result));
        }
