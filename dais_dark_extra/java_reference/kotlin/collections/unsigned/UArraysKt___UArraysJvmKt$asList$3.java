...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UByte) {
            return m615contains7apg3OU(((UByte) element).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int index) {
        return UByte.m107boximpl(m616getw2LRezQ(index));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object element) {
        if (element instanceof UByte) {
            return m617indexOf7apg3OU(((UByte) element).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object element) {
        if (element instanceof UByte) {
            return m618lastIndexOf7apg3OU(((UByte) element).getData());
        }
        return -1;
    }
    ...
    public int get_size() {
        return UByteArray.m172getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UByteArray.m174isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m615contains7apg3OU(byte element) {
        return UByteArray.m167contains7apg3OU(this.$this_asList, element);
    }

    /* renamed from: get-w2LRezQ, reason: not valid java name */
    public byte m616getw2LRezQ(int index) {
        return UByteArray.m171getw2LRezQ(this.$this_asList, index);
    }

    /* renamed from: indexOf-7apg3OU, reason: not valid java name */
    public int m617indexOf7apg3OU(byte element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* renamed from: lastIndexOf-7apg3OU, reason: not valid java name */
    public int m618lastIndexOf7apg3OU(byte element) {
