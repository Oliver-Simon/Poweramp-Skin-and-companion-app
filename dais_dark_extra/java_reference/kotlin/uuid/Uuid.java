...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m263boximpl(ULong.m269constructorimpl(getMostSignificantBits())), ULong.m263boximpl(ULong.m269constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1579toUByteArrayTcUX1vc() {
        return UByteArray.m166constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m269constructorimpl(this.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m269constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m269constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m269constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1581fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m1580fromUByteArrayGBYM_sE(byte[] ubyteArray) {
