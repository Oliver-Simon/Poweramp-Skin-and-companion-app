...
public final class UStringsKt {
    ...
    public static final String m1427toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1429toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1428toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1426toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m190constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m107boximpl(UByte.m113constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m190constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m370boximpl(UShort.m376constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m190constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m190constructorimpl(result * uradix);
            result = UInt.m190constructorimpl(UInt.m190constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m184boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m269constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m269constructorimpl(result * uradix);
            result = ULong.m269constructorimpl(ULong.m269constructorimpl(UInt.m190constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m263boximpl(result);
    }
}
