...
public final class UProgressionUtilKt {
    ...
    private static final int m1307differenceModuloWZ9TVnA(int a, int b, int c) {
        int compare;
        ...
        return UInt.m190constructorimpl(compare >= 0 ? ac - bc : UInt.m190constructorimpl(ac - bc) + c);
    }

    /* renamed from: differenceModulo-sambcqE, reason: not valid java name */
    private static final long m1308differenceModulosambcqE(long a, long b, long c) {
        int compare;
        ...
        return ULong.m269constructorimpl(compare >= 0 ? ac - bc : ULong.m269constructorimpl(ac - bc) + c);
    }

    /* renamed from: getProgressionLastElement-Nkh28Cs, reason: not valid java name */
    public static final int m1310getProgressionLastElementNkh28Cs(int start, int end, int step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Integer.compare(start ^ Integer.MIN_VALUE, end ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return UInt.m190constructorimpl(end - m1307differenceModuloWZ9TVnA(end, start, UInt.m190constructorimpl(step)));
            }
        } else {
            if (step >= 0) {
            ...
            if (compare > 0) {
                return UInt.m190constructorimpl(m1307differenceModuloWZ9TVnA(start, end, UInt.m190constructorimpl(-step)) + end);
            }
        }
        return end;
    }
    ...
    public static final long m1309getProgressionLastElement7ftBX0g(long start, long end, long step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Long.compare(start ^ Long.MIN_VALUE, end ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return ULong.m269constructorimpl(end - m1308differenceModulosambcqE(end, start, ULong.m269constructorimpl(step)));
            }
        } else if (step < 0) {
            compare = Long.compare(start ^ Long.MIN_VALUE, end ^ Long.MIN_VALUE);
            if (compare > 0) {
                return ULong.m269constructorimpl(m1308differenceModulosambcqE(start, end, ULong.m269constructorimpl(-step)) + end);
            }
        } else {
            throw new IllegalArgumentException("Step is zero.");
        }
